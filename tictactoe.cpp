...
public:
    ...
    void menu() {
      this->menuOn = true;
    	row = 9, menuChoice = 0, pause_menu = 0;
    ...
    void drawBoard(string name1, string name2, int gameMode) {
      inGame = true, restart = true, choice = true, pause;
      ...
      while (restart == true) //Loops the whole program, choice at the end to break
      {
        ...
        while (choice == true)	//Choice of playing more or closing the program.
        {
          ...
          if (GetAsyncKeyState(VK_RETURN))	//Takes the "row" value to restart or end the program
          {
            if (row == 0)
            {
              inGame = true;
...
private:
  ...
  bool inGame = true, restart = true, choice = true, pause;
